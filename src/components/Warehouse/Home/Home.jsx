...
const Home = () => {
	return (
		<div className='p-4'>
			...
			{/* list of products that are closed to due date  */}
			<div className=''>
						...
						<tbody>
							<tr className='bg-white'>
								...
								<td className='border px-3 py-4'>
									Los productos llegaron con fecha muy próxima a vencerse y no
									se precataron al momnento de ingresarlos en el almacen
								</td>
