...
// utils
import {
	searchForExistingClassificationInSupabase,
	insertNewClassificationInSupabase,
...
const AddClassificationdModal = ({ isOpen, closeModal }) => {
	...
	const onSubmitFormHandler = handleSubmit(data => {
		...
		const insertData = {
			name: data.productClassification,
			state: 1,
		}
	...
	useEffect(() => {
		...
		const onSearchBrandNameInSupabase = setTimeout(() => {
			searchForExistingClassificationInSupabase(inputQuery).then(response => {
				// hide spinner
				setShowSpinner(false)
								...
								<div className='mt-2'>
									<form className='w-full' onSubmit={onSubmitFormHandler}>
										<h3 className='text-lg font-medium leading-6 text-gray-900 border-b pb-2 mb-4'>
											Ingresar Nueva Clasificación de Producto
										</h3>
										...
										<div className='w-full bg-gray-50 border-l-4 border-gray-200 py-2 px-4 mb-4 '>
											<p className='text-gray-500 text-sm font-semibold flex flex-col'>
												<span className='flex'>
													...
													El nombre de la clasificación debe iniciar con letra
													mayúscula.
												</span>
												<span>
													Ejemplo:
										...
										<div className='flex flex-wrap -mx-3 mb-4'>
											<div className='w-full px-3 mb-6 md:mb-0'>
												...
												<input
													...
													id='grid-product-classification'
													type='text'
													placeholder='Nombre de la clasificación del producto'
...
export default AddClassificationdModal
