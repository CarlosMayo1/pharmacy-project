...
// utils
import {
	searchForExistingBrandInSupabase,
	insertNewBrandInSupabse,
} from '../../../../../utils/warehouse'
// redux-thunk
import { fetchProductBrand } from '../../../../../store/warehouseStore/warehouse-thunk'
// store
...
const AddBrandModal = ({ isOpen, closeModal }) => {
	...
	useEffect(() => {
		...
		const onSearchBrandNameInSupabase = setTimeout(() => {
			searchForExistingBrandInSupabase(inputQuery).then(response => {
				// hide spinner
				setShowSpinner(false)
										...
										<div className='w-full bg-gray-50 border-l-4 border-gray-200 py-2 px-4 mb-4 '>
											<p className='text-gray-500 text-sm font-semibold flex flex-col'>
												<span className='flex'>
													...
													El nombre de la marca debe iniciar con letra
													mayúscula.
												</span>
												<span>
													Ejemplo:
													<span className='font-bold ml-1'> Portugal</span>
												</span>
											</p>
										</div>
